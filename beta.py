...
def get_filters():
    ...
    months =['January', 'February', 'March','April', 'May',  'June','0']

    while True:
        month =input("Please choose which month you would like more information or '0' for all months, ex  January\n")
    ...
    while True:
        day = input('Please choose a day you would like more information on or "0" for the whole week, ex Monday\n')
...
def time_stats(df):
    ...
    common_start_hour = df['Start Time'].value_counts()
...
def main():
    while True:
        ...
        print( time_stats, station_stats,trip_duration_stats,user_stats)
